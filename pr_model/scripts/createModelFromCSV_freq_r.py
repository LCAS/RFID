...
if __name__ == '__main__':
    ...
    modelURI = fileURI[0:-4]+'_gmm_models_polar.pickle'
    minmodelURI = fileURI[0:-4] + '_gmm_models_min_polar.pickle'
    ...
    header = ['Time', 'rel_r_m', 'rel_tetha_rad', 'rel_yaw_rad', 'rssi_dbm', 'phase_deg']
