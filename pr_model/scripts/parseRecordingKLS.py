...
class myParser():
    ...
    def lastTask(self):
         labels = ['ROS Time','RFID Timestamp','ID','rel_x_m', 'rel_y_m', 'rel_yaw_rad', 'freq_khz', 'rssi_dbm', 'phase_deg','robot_x_m', 'robot_y_m', 'robot_yaw_rad']
    ...
    def tagCallback1(self,data):
        ...
        timest = data.timestamp.secs + data.timestamp.nsecs/1000000000
    ...
    def processTagData(self,timest, tid, rssi_db, phase_deg, freq_khz):
        if self.do:
            ...
            entry = (now,timest, tid,rel_x,rel_y,rel_yaw,freq_khz,rssi_db,phase_deg,rob_x,rob_y,rob_yaw)
